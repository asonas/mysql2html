...
<title><?php h($documnet['name']);?>(systemname=<?php h($documnet['systemname']);?>, dbname=<?php h($database['dbname']);?>)</title>
...
<div class="outer">
    <div class="documenttitle">
        <h1><?php h($documnet['name']);?></h1>
        <h2><?php h($documnet['systemname']);?></h2>
        <h3><?php h(date('Y/m/d'));?><br/ ><?php h($documnet['author']);?></h3>
    </div>
</div>
    ...
    <div class="informations">
        ...
        <table class="headers">
            <tr>
                ...
                <td><?php h($documnet['systemname']);?></td>
